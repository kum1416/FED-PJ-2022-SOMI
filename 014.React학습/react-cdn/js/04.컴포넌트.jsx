...
*************************************************/
// 내가 좋아하는 색 표시하기 컴포넌트 ////
function Favorite(props){ // props는 속성셋팅 변수집합 😀전달값을 props로 받음
    return (
        <h2>
            내가 좋아하는 색은 {props.color}이야! <br />
            그리고 좋아하는 음식은 {props.food}야! <br />
            취미는 {props.hobby}다! 알겠니???
        </h2>
    );
...
ReactDOM.render(
<Favorite color="빨간색" food="피자" hobby="게임" />, // 속성형식으로 씀 내가정한이름
...
// 좋아하는 색을 props로 전달할 수 있다!
ReactDOM.render(
    <Favorite color="파란색" food="알리오올리오" hobby="야구" />, // 속성형식으로 씀 내가정한이름
