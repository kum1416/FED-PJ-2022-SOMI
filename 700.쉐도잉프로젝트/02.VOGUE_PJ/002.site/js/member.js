...
$(()=>{
  ...
  seleml.change(function(){
    ...
    // 1. 선택박스 변경된 값 읽어오기
    let cv = $(this).val();
    console.log("선택값:",cv); // 찍으면 옵션에 밸류값이 나오는것임
 ...
 $("#email1,#email2").on("keyup",function(){
  ...
  /****************************************** 
    ...
    기능 : 이메일 검사결과 처리
  ******************************************/
 const resEml = (comp) => { // 화살표함수 할당 comp-> 아무이름 x가될수도 다른게될수도..
    // comp - 완성된 이메일 주소
 ...
 **************************************************/
    ...
    $("#btnj").click(e=>{
        ...
        // false로 할당되면 결과는 false다! ^_^맑은물 똥물... 백일홍 이야기
        pass = true; // pass를 밖에 쓴 이유...? 다시듣기...
